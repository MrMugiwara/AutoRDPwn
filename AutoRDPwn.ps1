...
if ($nogui){ Write-Host $txt66 -ForegroundColor Green ; Write-Host ; Write-Host "mstsc /v $env:computername.tolower() /admin /shadow:$shadow /control /noconsentprompt /prompt /f"
